<template>
    <ul class="pagination">
        <li :class="{ disabled: source.current_page == 1}"><a href="#!" @click="nextPrev($event, source.current_page-1)"><i class="material-icons">chevron_left</i></a></li>
        ...
        <li :class="{ disabled: source.current_page == source.last_page }"><a href="#!" @click="nextPrev($event, source.current_page+1)"><i class="material-icons">chevron_right</i></a></li>
    </ul>
